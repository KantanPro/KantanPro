 ...
 * - 最新バージョン: 1.0.27 - 2025年8月14日更新
* - 更新チェック問題修正
* - リポジトリ名を修正（KantanPro/KantanPro-a- → KantanPro/KantanPro）
* - 協力会社のエラーを修正
 * - 自動マイグレーション機能の改善（データベース更新処理の安定化・エラーハンドリング強化・マイグレーション安全性の向上・バージョン管理の最適化）
 ...
 * - ３桁カンマ問題の修正（数値表示のフォーマット改善）
 * - サービス選択からの入力改善（ポップアップ機能の最適化）
 *
 * @package KTPWP
 * @subpackage Includes
 * @since 1.2.2
		...
		private function get_changelog_content() {
            ...
            <div class="ktpwp-reference-section">
				...
				<div class="ktpwp-changelog-item">
					<h4>1.0.27 - 2025年8月14日</h4>
					<ul>
						<li><strong>受注書プレビュー印刷を閉じる際のバグ修正</strong></li>
					</ul>
				</div>
                ...
                <div class="ktpwp-changelog-item">
                    ...
                    <ul>
                        <li><strong>サーバー移転対応</strong>
                            <ul>
                                <li>サーバー移転時のためのデータ処理機能を追加（エクスポート/インポート補助、URL/パス置換、エンコード正規化、ドライラン、ログ出力）</li>
                            </ul>
                        </li>
                    </ul>
                </div>
                ...
                <div class="ktpwp-changelog-item">
                    <h4>1.0.23 - 2025年8月11日</h4>
                    <ul>
                        <li><strong>消費税モード対応</strong>
                            <ul>
                                <li>税制モードの切替（消費税あり / 消費税なし）</li>
                                <li>税率/税額列や内訳表示の自動表示制御</li>
                                <li>請求書・受注書・メール本文での税表示を一貫制御</li>
                            </ul>
                        </li>
                    </ul>
                </div>
				...
				<div class="ktpwp-changelog-item">
					<h4>1.0.17 - 2025年8月5日</h4>
					<ul>
						<li><strong>更新チェック問題修正</strong></li>
						<li><strong>リポジトリ名を修正</strong>（KantanPro/KantanPro-a- → KantanPro/KantanPro）</li>
						<li><strong>ダミーデータ作成スクリプトの配布対応</strong></li>
					</ul>
				</div>

				<div class="ktpwp-changelog-item">
					<h4>1.0.16 - 2025年8月6日</h4>
					<ul>
						<li><strong>協力会社のエラーを修正</strong></li>
					</ul>
				</div>

				<div class="ktpwp-changelog-item">
					<h4>1.0.15 - 2025年8月5日</h4>
					<ul>
						<li><strong>ライセンス無効時のレポートタブ修正</strong></li>
					</ul>
				</div>
				...
				<div class="ktpwp-changelog-item">
					<h4>1.0.12 - 2025年8月4日</h4>
					<ul>
						<li><strong>ライセンスステータスの改善</strong>
							<ul>
								<li>ライセンス管理システムの安定性向上</li>
								<li>ライセンス検証機能の改善</li>
								<li>ライセンス情報表示の最適化</li>
								<li>ライセンス状態の可視性向上</li>
							</ul>
						</li>
						<li><strong>ライセンス無効中のレポート表示の改善</strong>
							<ul>
								<li>ライセンス無効時のレポート機能の安定化</li>
								<li>レポート表示のエラーハンドリング強化</li>
								<li>ライセンス状態に応じた適切な表示制御</li>
