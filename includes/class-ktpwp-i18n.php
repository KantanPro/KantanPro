...
class KTPWP_I18n {
    ...
    private function get_dictionary() {
        ...
        $this->dictionary = array(
            ...
            'KantanPro 無料版は、有料版（KantanProEX）が有効化されているため停止中です。設定メニューと機能はKantanProEX側で表示され、ショートコードはそのまま有料版へ引き継がれています。' => 'KantanPro free edition is suspended because KantanProEX (Pro) is active. Settings and features are available in KantanProEX, and the shortcode is handed over to the Pro edition.',
            'KantanProEX（有料版）へ移行してご利用ください。' => 'Please migrate to KantanProEX (Pro) to continue.',
            'KantanProEX 商品ページ' => 'KantanProEX product page',
            '非表示' => 'Hide',
            '閉じる' => 'Close',
            '開く' => 'Open',
            '保存' => 'Save',
