...
rsync -a \
  ...
  --exclude 'js/ktpwp-update-checker.js' \
  --exclude 'js/ktpwp-update-balloon.js' \
  --exclude 'css/ktpwp-update-balloon.css' \
  --exclude 'js/ktp-license-manager.js' \
  --exclude 'languages/' \
...
for f in includes/class-ktpwp-update-checker.php includes/class-ktpwp-license-manager.php \
         js/ktpwp-update-checker.js js/ktpwp-update-balloon.js \
         css/ktpwp-update-balloon.css js/ktp-license-manager.js; do
  if [[ -e "$STAGE/$f" ]]; then
